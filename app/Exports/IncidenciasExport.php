...
class IncidenciasExport implements FromCollection,  WithProperties, WithDrawings, ShouldAutoSize, WithEvents, WithCustomStartCell, WithColumnWidths, WithHeadings, WithMapping
{
    ...
    public function __construct($localidad, $area, $falta_empleado, $fecha1, $fecha2)
    {
    ...
    */
    ...
    {
        return Incidencia::with('persona')
    ...
    public function properties(): array
    {
        return [
            ...
            'title'          => 'Reporte de Incidencias (Sistema de Gestión Personal)',
