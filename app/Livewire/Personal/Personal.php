...
class Personal extends Component
{
    ...
    protected function rules(){
        return [
            ...
            'modelo_editar.telefono' => 'required|unique:personas,telefono,' . $this->modelo_editar->id,
            'modelo_editar.domicilio' => 'required',
            'modelo_editar.email' => 'required|email:rfc,dns|unique:personas,email,' . $this->modelo_editar->id,
