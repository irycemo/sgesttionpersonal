<div class="">
    ...
    <x-dialog-modal wire:model="modal">
        ...
        <x-slot name="content">
            ...
            <x-input-group for="modelo_editar.localidad" label="Localidad" :error="$errors->first('modelo_editar.localidad')" class="">

                <x-input-select id="modelo_editar.localidad" wire:model="modelo_editar.localidad" class="">
